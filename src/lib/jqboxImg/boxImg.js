 ...
 */
function zoomImg () {
    var len = $(".boxZoomImg").length;
    var arrPic = new Array(); //定义一个数组
    for (var i = 0; i < len; i++) {
        arrPic[i] = $(".boxZoomImg").eq(i).attr("src"); //将所有img路径存储到数组中
    }

    $(".boxZoomImg").each(function () {
        $(this).on("click", function () {
            ...
            $("body").append("<div class=\"mask-layer\">" +
                ...
                "           <button class=\"mask-prev btn-default-styles layui-btn layui-bg-blue\" style=\"float: left;display: none;\">上一张</button>" +
                "           <button class=\"mask-out btn-default-styles layui-btn layui-bg-blue\">放大</button>" +
                "           <button class=\"mask-in btn-default-styles layui-btn layui-bg-blue\">缩小</button>" +
                "           <button class=\"mask-clockwise btn-default-styles layui-btn layui-bg-blue\">顺旋转</button>" +
                "           <button class=\"mask-counterclockwise btn-default-styles layui-btn layui-bg-blue\">逆旋转</button>" +
                "           <button class=\"mask-close btn-default-styles layui-btn layui-bg-blue\">关闭</button>" +
                "           <button class=\"mask-next btn-default-styles layui-btn layui-bg-blue\" style=\"float: right;display: none;\">下一张</button>" +
                "       </div>" +
            ...
            var img_index = $(".boxZoomImg").index(this);//获取点击的索引值
            var num = img_index;

            function showImg() {
                $(".mask-layer-imgbox").append("<p><img src=\"\" alt=\"\"></p>");
                $(".mask-layer-imgbox img").attr("src", arrPic[num]); //给弹出框的Img赋值
